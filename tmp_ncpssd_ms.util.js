...
(function() {
    ...
    $.getJSON("/get/server/date", function (data){
        serverdate = data.data;
    })
    /**
     * 获取资源服务器接口调用秘钥
     *
     * @returns
     */
    function getMinioSign(callback) {
        var sign = ''
        $.ajax({
            type: "POST",
            url: "/common/getMinioSign",
